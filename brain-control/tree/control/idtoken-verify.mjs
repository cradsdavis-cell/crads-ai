// VENDORED from ai-os wizard/panel/idtoken-verify.mjs (loop/verified-handshake).
// Keep byte-identical apart from this header; the ai-os copy is the source of truth.
